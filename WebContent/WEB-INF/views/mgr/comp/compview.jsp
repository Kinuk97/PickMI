		...
		success : function(data) {
			...
			for (var i = 0; i < replyList.length; i++) {
				...
				var userno = "${userno}";
					...
					btn.append($("<button class='btn btn-warning' onclick='location.href=\"/mgr/compreplydelete?replyno=" + replyList[i].replyno + "&boardno=${compBoard.comp_no}&curPage=" + curPage + "\";'>삭제</button>"));	
