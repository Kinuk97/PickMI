	...
	<form class="form-horizontal" action="/compBoard/write" method="post" enctype="multipart/form-data">
  		...
  		<div class="form-group">
    		...
    		<div class="col-sm-9 col-md-9 col-lg-2">
      			<input type="number" class="form-control" id="comp_member" placeholder="(Ex.5)" name="comp_member" >
    		</div>
    		...
    		<div class="col-sm-9 col-md-9 col-lg-3">
      			<input type="date" class="form-control" id="comp_startdate" placeholder="(ex.20191111)" name="comp_startdate">
    		</div>
    		
    		<label class="col-sm-1 col-md-1 col-lg-1 control-label" 
    			   style="padding-top: 8px; text-align: center;">프로젝트 종료날짜</label>
    		<div class="col-sm-9 col-md-9 col-lg-3">
      			<input type="date" class="form-control" id="comp_enddate" placeholder="(ex.20191114)" name="comp_enddate">
    		</div>
