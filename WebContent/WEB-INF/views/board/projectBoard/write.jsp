...
<div class="container text-center">
	...
	<form class="form-horizontal" action="/projectBoard/write"
		...
		<button class="btn btn-default" id="write"
			onclick="alert('글 작성을 완료하시겠습니까?')">작성완료</button>
		<button class="btn btn-default" type="button" id="cancel"
			onclick="alert('글 작성을 취소하시겠습니까?')">취소</button>
